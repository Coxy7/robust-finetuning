...
class ImageNetADataset(EvaluationDataset):
    ...
    def __init__(self, data_dir, size=224, interpolation='bicubic', transform='std'):
        ...
        self.sub_dir = 'imagenet-a'
        concerned_classes = set(IMAGENET_A_CLASSES)
        self.ignored_classes = [i for i in range(self.num_classes)
                                if i not in concerned_classes]
        self.target_transform = (lambda y: IMAGENET_A_CLASSES[y])
